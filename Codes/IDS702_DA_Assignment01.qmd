...
```{r}
# Insert R code chunk to generate summary table
quarto_chunk(doc, "summary_table", "R", "
  # Generate summary table
  summary_table <- summary(model_v2)
  summary_table
")

# Insert R code chunk to generate VIF plot
quarto_chunk(doc, "vif_plot", "R", "
  # Generate VIF plot
  library(car)
...
# Insert R code chunk to generate diagnostic plots
quarto_chunk(doc, "diagnostic_plots", "R", "
